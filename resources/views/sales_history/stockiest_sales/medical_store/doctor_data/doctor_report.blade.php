                                ...
                                @foreach($get_medical_store_data as $gk => $gv)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control number change_amount amount_{{$gv->id}}" name="brand_priority" autocomplete="off" data-id="{{$gv->id}}" @if(is_null($gv->commission)) disabled @endif @if($gv->sales_amount != '' || $gv->sales_amount == 0) data-value="{{$gv->sales_amount}}" value="{{$gv->sales_amount}}"  @endif >
