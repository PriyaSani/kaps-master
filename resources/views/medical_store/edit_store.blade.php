                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="store_name" placeholder="Store Name" value="{{$get_store_detail->store_name}}" autocomplete="off" onkeypress="return /^[a-zA-Z\. ]*$/.test(event.key)" required/>
